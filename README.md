...
Creative Commons Attribution 4.0 - for documentation and content in the assets, content, and data folders (see [LICENSE](LICENSE))MIT License** - for code (see [LICENSE-CODE](LICENSE-CODE))
